class Admin::ServicesController < Admin::BaseController
  ...
  private
    def alldata
      @current_page = {model: Service, title: 'Справочник: Услуги', 
        comment: 'Список услуг, предоставляемых компанией с кратким описанием их.'}
    end
    ...
    def service_params
      params.require(:service).permit(:start_dt, :name, :content, :sort)
    end
end
